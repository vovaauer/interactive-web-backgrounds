...
function __wbg_adapter_30(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4a41fe34c770391a(arg0, arg1);
}
...
const AquariumFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aquarium_free(ptr >>> 0, 1));

export class Aquarium {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Aquarium.prototype);
        obj.__wbg_ptr = ptr;
        AquariumFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        AquariumFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_aquarium_free(ptr, 0);
    }
    /**
    ...
    static new(canvas_id) {
        ...
        const ret = wasm.aquarium_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Aquarium.__wrap(ret[0]);
    }
    /**
     * @param {number} x
     * @param {number} y
     */
    add_food(x, y) {
        wasm.aquarium_add_food(this.__wbg_ptr, x, y);
    }
    /**
     * @param {number} x
     * @param {number} y
     */
    add_fish(x, y) {
        wasm.aquarium_add_fish(this.__wbg_ptr, x, y);
    }
    tick() {
        wasm.aquarium_tick(this.__wbg_ptr);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('aquarium_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
